...
class ServiceConfigurations extends Component {
    ...
    render() {
        const { service_configs: templates } = this.props;
        ...
        return (
            <div className="animated fadeIn">
                <ol className="breadcrumb">
                    <li className="breadcrumb-item active">Service Configurations</li>
                </ol>
                <div className="container-fluid">
                    <div className="d-flex justify-content-between">
                        {this.state.hasReadAccess ? <Card className="flex-grow-1">
                            <CardHeader>Service Configurations</CardHeader>
                            <CardBody>
...
function mapStateToProps({ service_configs }) {
    return {
        service_configs
    };
}
...
export default (connect(mapStateToProps, mapDispatchToProps)(ServiceConfigurations));
