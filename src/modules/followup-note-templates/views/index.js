...
class Groups extends Component {
    ...
    render() {
        const { followup_templates: templates } = this.props;
        ...
        return (
            <div className="animated fadeIn">
                <ol className="breadcrumb">
                    <li className="breadcrumb-item active">Follow-Up Note Templates</li>
                </ol>
                <div className="container-fluid">
                    <div className="d-flex justify-content-between">
                        {this.state.hasReadAccess ? <Card className="flex-grow-1">
                            <CardHeader>Follow-Up Note Templates</CardHeader>
                            <CardBody>
